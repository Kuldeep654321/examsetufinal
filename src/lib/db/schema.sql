-- ExamSetu (examsetu.in) Database Schema
...
CREATE TABLE IF NOT EXISTS states (
    ...
    type VARCHAR(10) NOT NULL DEFAULT 'state',
    capital VARCHAR(100)
);
...
CREATE TABLE IF NOT EXISTS exams (
    ...
    conducting_org_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
    state_id UUID REFERENCES states(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS exam_updates (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    exam_id UUID NOT NULL REFERENCES exams(id) ON DELETE CASCADE,
    event_id UUID REFERENCES exam_events(id) ON DELETE SET NULL,
    title VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS review_queue (
    ...
    target_entity_type VARCHAR(50) NOT NULL, -- 'exam', 'exam_event', 'opportunity', 'exam_update'
...
CREATE TABLE IF NOT EXISTS application_tracker (
    ...
    target_type VARCHAR(20) NOT NULL, -- 'exam' or 'opportunity'
